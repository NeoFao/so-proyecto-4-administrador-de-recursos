@echo off
REM ===========================================================================
REM EJECUTAR (Demostraciones).bat -- Recorrido guiado del Proyecto 4.
REM Administrador Simplificado de Recursos -- Fabrizio Espinoza Arce
REM TIIT2007 Sistemas Operativos, Universidad Invenio
REM
REM Compila, ejecuta la suite de pruebas y recorre UNO POR UNO los cuatro
REM requisitos funcionales, los dos no funcionales y los tres resultados
REM experimentales, conduciendo el menu de forma automatica y diciendo en cada
REM paso cual se esta demostrando.
REM
REM Para USAR la herramienta a mano, con el menu interactivo, use
REM EJECUTAR.bat.
REM
...
echo       (30 pruebas: archivos, frontera del directorio, contratos de
